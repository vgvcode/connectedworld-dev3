trigger beforeUpdateOnQuestion on Question__c (before update) {
    ...
    //image upload is handled via after update trigger 
	//if you supply an image and a reuse image url, the image will overwrite the reuse image url      
}